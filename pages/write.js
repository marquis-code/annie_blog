...
import {handleNewPost} from '../../blog/components/endpoints';
...
const UserBlogPost = () => {
    ...
    return (
        ...
        <section className="bg-white flex justify-center items-center max-w-7xl mx-auto">
            <div className="lg:px-5 px-3 border py-6 rounded shadow-sm lg:w-6/12 z-50 bg-gray-100">
                ...
                <h1 className="text-center font-bold font-serif  text-2xl py-3">Create New Post</h1>
                <form onSubmit={handleSubmit}>
                  <div className="py-2 flex flex-col">
                    ...
                    {loading ? (
                        <button className="font-semibold font-sans rounded shadow-sm bg-green-500 w-full text-white py-2 mt-4">Publishing...</button>
                    ) : (
                        <button className="font-semibold font-sans rounded shadow-sm bg-green-500 w-full text-white py-2 mt-4">Publish</button>
                    )}
                </form>
            </div>
        </section>
        <div className='bg-black py-3 space-y-3 p-3'>
